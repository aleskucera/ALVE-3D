...
cmake . -DPYTHON_LIBRARY=$CONDA_ENV/lib/libpython3.10.so -DPYTHON_INCLUDE_DIR=$CONDA_ENV/include/python3.10 -DBOOST_INCLUDE_DIR=$CONDA_ENV/include -DEIGEN3_INCLUDE_DIR=$CONDA_ENV/include/eigen3
make
